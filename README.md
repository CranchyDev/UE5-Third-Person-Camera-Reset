# UE5-Camera-Reset-Rotation
Short and simple Camera Reset mechanic for **Third Person Cameras only**, that modifies the Control Rotation Yaw towards the Actor's Rotation Yaw through RInterpTo/RConstantInterpTo (you can choose). Pitch is default 0.0f but can be Actor's Rotation Pitch instead. C++ and Blueprint available!
